...
from agent.intent_model import activate_intent_model_version, list_intent_model_versions, rollback_intent_model
...
def main() -> None:
    ...
    activate.add_argument("--json", action="store_true", help=argparse.SUPPRESS)
    rollback = subparsers.add_parser("rollback", help="activate the previous model version")
    rollback.add_argument("--json", action="store_true", help=argparse.SUPPRESS)
