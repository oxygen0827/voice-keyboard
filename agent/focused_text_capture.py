...
def classify_text_capture(
    *,
    ...
    if source == "AXStringForRange":
        return "high"
    if source.startswith("UIAutomation:"):
        return "medium"
    if source == "Win32:WM_GETTEXT":
        return "medium"
...
class FocusedTextCapture(Protocol):
    ...
    def clipboard_probe_snapshot(self, expected_text: str = "") -> CorrectionTextSnapshot:
        ...
...
class TyperFocusedTextCapture:
    ...
    def clipboard_probe_snapshot(self, expected_text: str = "") -> CorrectionTextSnapshot:
        ...
        if hasattr(typer, "probe_full_text_via_clipboard"):
            return typer.probe_full_text_via_clipboard()
        return CorrectionTextSnapshot("", source="unsupported")
